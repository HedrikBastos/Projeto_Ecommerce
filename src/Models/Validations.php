...
class Validations
{
    ...
    public function valid()
    {
        ...
        try {
            ...
            // Criaria uma variável aqui, e cada exceção de cada if receberia ela se a condicional fosse verdaderia, ai daria um jeito de jogara essa vaariáavel na view pelo controller e a gente estilizava a variável lá.
