<section>
<h2 class="text-2xl font-normal sm:text-3xl" >Seus Pedidos</h2>
    <div class="max-w-screen-xl mx-auto p-4">
        ...
        foreach ($pedidos as $pedido) {
            ...
            $precoProduto = $pedido['pedido']['preco'] * $pedido['pedido']['quantidade'];
            $pedidosAgrupados[$idPedido]['total'] += $precoProduto;
            $pedidosAgrupados[$idPedido]['quantidadeTotal'] += $pedido['pedido']['quantidade'];
        }
                ...
                <div class="flex flex-col items-start">
                    <div class="flex flex-col items-start">
                        ...
                        <div class="relative ml-auto right-10 text-sm font-medium uppercase text-slate-600 text-center sm:absolute">
                            <?php echo 'Quantidade de Produtos: ' . $pedidoAgrupado['quantidadeTotal'] ?>
                        </div>
                    </div>

                    <div class="text-lg font-medium text-slate-700">
                        <?php echo 'Total: R$ ' . number_format($pedidoAgrupado['total'], 2, ',', '.') ?>
                    </div>
                </div>
