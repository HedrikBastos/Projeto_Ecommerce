...
<body class=" bg-[#F7F7F7] ">
    ...
    <head class="">
        ...
        <nav id="menuResponsivo" class="hidden justify-center w-[100%] bg-blue-600 md:hidden">
            <ul class=" flex flex-col w-[100%] text-center text-white ">
    ...
    <article class=" flex justify-center items-center ">
        ...
        <div class=" flex flex-wrap justify-center w-[1300px] p-[10px] gap-1 ">
            <?php foreach ($produtos as $key => $valor) : ?>
                ...
                <a class=" produtos flex flex-col items-center justify-center w-[200px] text-center relative border-hidden border-[1px] border-black  hover:border-solid " href="show/<?= $valor['id_produto'] ?>">
