...
<body class="flex justify-center items-center h-[100vh] ">
    ...
    <div class="containerpaginacao">
        <div class="paginacao active flex rounded-3xl shadow-[0_5px_40px_-5px_rgba(0,0,0,0.3)] shadow-slate-900 " id="registro-usuario">
            <div class=" flex flex-col justify-center items-center py-[60px] px-[60px] gap-5 lg:px-[80px] lg:py-[80px] ">
                <form class=" flex flex-col justify-center items-center gap-4" action="cadastro" method="post">
                    ...
                    <input type="text" name="nome" placeholder="Nome" class="campo-obrigatorio rounded-md bg-slate-200 w-[220px] p-1 border-b-2 outline-none">
                    <input type="text" name="sobrenome" placeholder="Sobrenome" class="campo-obrigatorio rounded-md bg-slate-200 w-[220px] p-1 border-b-2 outline-none">
                    ...
                    <a class=" text-xs" href="login">Tenho conta</a>
            
            </div>
        </div>
        <div class="paginacao flex rounded-3xl shadow-[0_5px_40px_-5px_rgba(0,0,0,0.3)] shadow-slate-900 " id="registro-endereco">
            <div class=" flex flex-col justify-center items-center py-[60px] px-[60px] gap-5 lg:px-[80px] lg:py-[80px] ">
