        ...
        <div class="rounded-3xl shadow-[0_5px_40px_-5px_rgba(0,0,0,0.3)] shadow-slate-900">
            <div class="flex flex-col justify-center items-center py-[60px] px-[60px] gap-5 lg:px-[80px] lg:py-[80px]">
                <form class=" flex flex-col justify-center items-center gap-4" action="alteracadastro" method="post">
                    ...
                    <input type="text" name="cpf" placeholder="CPF" id="cpf" class=" rounded-md bg-slate-200 w-[220px] p-1 border-b-2 outline-none" maxlength="11" value="<?php echo $usuario->cpf(); ?>">
                    ...
                    <input type="password" name="senha" placeholder="Nova Senha" id="senha" class="campo-obrigatorio rounded-md bg-slate-200 w-[220px] p-1 border-b-2 outline-none" minlength="4" maxlength="8">
                    ...
                    <div class="left">
                        <input type="submit" name="acao" id="btnProximo" value="Salvar" class=" w-[140px] text-center rounded-md p-1 bg-blue-600  text-white">
                    </div>
